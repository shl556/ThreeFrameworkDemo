...
<!--      用户注册表单        -->
<div  align="center">
	<form name="register_form" onSubmit="register_check()" action="AddUser.jsp" method="post">
		<table>
		    <tr><td colspan="2"> &nbsp;<span class="errmsg">${msg} </span></td></tr>
		    <tr>
		        <td class="input">用户名：</td>
		        <td><input type="text" name="lgname"/></td>
		    </tr>
		    <tr>
		         <td class="input">密码：</td>
		         <td><input type="password" name="lgpass"/></td>
		    </tr>
		    <tr>
		         <td class="input">确认密码：</td>
		         <td><input type="password" name="lgpass_validate"/></td>
		    </tr>
		    <tr>
