...
public class MovieLists3 {
    ...
    public static final String RESULT = "results/movie_lists_3.pdf";
    ...
    public void createPdf(String filename)
        ...
        while (rs.next()) {
            ...
            for(Movie movie :
                ...
                // 采用带圆圈的数字符号作为序列符号，构造器中的参数是代表符号类型，可选值是0-3，另外
                //该序列只有1-10的范围，过长的序列会报错
                List directorlist = new ZapfDingbatsNumberList(1);
                //采用特定符号作为序列号，构造器中的参数为类型选择参数，ZapfDingbatsNumberList是其子类
//                List directorlist = new ZapfDingbatsList(45);
