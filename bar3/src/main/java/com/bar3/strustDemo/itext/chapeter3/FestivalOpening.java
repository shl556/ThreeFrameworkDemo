...
public class FestivalOpening {
    ...
    public static void main(String[] args)
        ...
        document.add(img);
        // 获取图片层的上一层
        //当document初始化完成后会自动初始化四个绘画层，中间两层依次是填充文本和图片的层，
        //不能直接访问，第一层和第四层可以通过getDirectContent()方法和getDirectContentUnder()
        //获取，然后通过相关画图，填充文字等方式画图
...
//        设置边框或者描边的宽度
        ...
        //会完全覆盖底下三层的内容
//        over.saveState();
//        over.setRGBColorFill(0xFF, 0xD7, 0x00);
//        over.rectangle(5, 5,
