...
public class DirectorPhrases1 {
    ...
    public static final String RESULT = "results/director_phrases_1.pdf";
    ...
    public Phrase createDirectorPhrase(ResultSet rs)
        ...
        //Phrase相当于Chunk的ArrayList
    	//另外注意Phrase不需要显示设置行间距，系统会根据字体大小自动应用字体大小1.5倍的行间距，可通过setLeading显示设置
