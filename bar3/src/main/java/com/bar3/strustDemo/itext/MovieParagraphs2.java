...
public class MovieParagraphs2 extends MovieParagraphs1 {
    ...
    public static final String RESULT = "results/movie_paragraphs_2.pdf";
    ...
    public void createPdf(String filename)
        ...
        for (Movie movie : movies) {
            ...
            if (movie.getOriginalTitle() != null) {
                Paragraph dummy = new Paragraph("sunhongliang", FilmFonts.NORMAL);
                //设置负值后会跑到元贝的上一行的上面,设为0的话会在同一行，可能覆盖原的文本内容
                dummy.setLeading(0);
                dummy.setAlignment(Element.ALIGN_LEFT);
                document.add(dummy);
